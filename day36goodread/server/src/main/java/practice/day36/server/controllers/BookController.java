package practice.day36.server.controllers;
...
import practice.day36.server.services.BookService;
...
public class BookController {
    ...
    public ResponseEntity<String> getBookById(@PathVariable String bookId) {
        Optional<practice.day36.server.models.Book> opt = bookSvc.getBookById(bookId);
        if (opt.isEmpty())
